...
#define STRING_CONFIG_H_AUTHOR "AbadiaTecnologica" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          {167, 167, 40, 167}
...
#define Z_PROBE_SPEED_SLOW Z_PROBE_SPEED_FAST  //(Z_PROBE_SPEED_FAST / 10)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION X_MAX_POS -10 - (X_PROBE_OFFSET_FROM_EXTRUDER)
  #define FRONT_PROBE_BED_POSITION Y_MIN_POS + (Y_PROBE_OFFSET_FROM_EXTRUDER)
  #define BACK_PROBE_BED_POSITION  Y_MAX_POS -10 - (Y_PROBE_OFFSET_FROM_EXTRUDER)
 ...
 */
  ...
  //Posiciones encima de los tornillos de nivelación (los delanteros un poco más al interior porque no se puede más cerca
  #define PROBE_PT_1_X 147 // 119  //Central Trasero
  #define PROBE_PT_1_Y 209 // 183
  #define PROBE_PT_2_X 91  // 62   //Delante Izquierda
  #define PROBE_PT_2_Y 26  //
  #define PROBE_PT_3_X 203 // 119   //Delante Derecha
  #define PROBE_PT_3_Y 26  
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 1), (Y_MIN_POS ), 25 }
